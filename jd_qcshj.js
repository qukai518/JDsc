...
[task_local]
#汽车生活节
40 0 12-20 8 * jd_qcshj.js, tag= 汽车生活节
================Loon==============
[Script]
cron "40 0 12-20 8 *" script-path= jd_qcshj.js,tag= 汽车生活节
===============Surge=================
汽车生活节 = type=cron,cronexp="40 0 12-20 8 *",wake-system=1,timeout=3600,script-path= jd_qcshj.js
============小火箭=========
汽车生活节 = type=cron,script-path= jd_qcshj.js, cronexpr="40 0 12-20 8 *", timeout=3600, enable=true
*/
const $ = new Env('汽车生活节')
