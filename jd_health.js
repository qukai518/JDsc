...
[task_local]
#东东健康社区
1 1,22 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_health.js, tag=东东健康社区, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "1 1,6,22 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_health.js, tag=东东健康社区
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      $.newShareCodes = [...inviteCodes ,"T0225KkcR0pI9lDVdRnznKYKJwCjVfnoaW5kRrbA","T0225KkcRRsY8lLfch-hwvIJIgCjVfnoaW5kRrbA"];
    }
