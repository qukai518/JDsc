...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://gitee.com/seec/share-codes/raw/master/city.json')
  if (!res) {
    res = await getAuthorShareCode('https://gitee.com/seec/share-codes/raw/master/city.json')
  }
  if (res) {
