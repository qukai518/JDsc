/*
组队分豆-蒙牛 [kk_mengniu.js]

————————————————
入口：[组队分豆-蒙牛 (https://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=4e3b9b6233104c199c0c44ff6edbc85d&signUuid=d5093523172d4e13b9dce2b2e3727748)]
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=4e3b9b6233104c199c0c44ff6edbc85d&signUuid=d5093523172d4e13b9dce2b2e3727748`)
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['d5093523172d4e13b9dce2b2e3727748']
            $.bean = 0;
