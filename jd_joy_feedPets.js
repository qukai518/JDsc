...
[task_local]
#京东宠汪汪喂食
15 0-23/1 * * * https://raw.githubusercontent.com/danteswx/fxxk/main/jd_joy_feedPets.js, tag=京东宠汪汪喂食, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

==============Loon===============
[Script]
cron "15 0-23/1 * * *" script-path=https://raw.githubusercontent.com/danteswx/fxxk/main/jd_joy_feedPets.js,tag=京东宠汪汪喂食

=========Surge=============
[Script]
京东宠汪汪喂食 = type=cron,cronexp="15 0-23/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/danteswx/fxxk/main/jd_joy_feedPets.js

===============小火箭==========
京东宠汪汪喂食 = type=cron,script-path=https://raw.githubusercontent.com/danteswx/fxxk/main/jd_joy_feedPets.js, cronexpr="15 0-23/1 * * *", timeout=3600, enable=true
*/
...
function feedPets(feedNum) {
  return new Promise(resolve => {
    ...
    let opt = {
      url: `jdjoy.jd.com/common/pet/feed?feedCount=${feedNum}&reqSource=h5&invokeKey=qRKHmL4sna8ZOP9F&validate=${$.validate}`,
...
function ThreeMeals() {
  return new Promise(resolve => {
    let opt = {
      url: "jdjoy.jd.com/common/pet/getFood?taskType=ThreeMeals&reqSource=h5&invokeKey=qRKHmL4sna8ZOP9F&validate=${$.validate}",
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5&invokeKey=Oex5GmEuqGep1WLC",
      method: "GET",
      data: {},
      credentials: "include",
