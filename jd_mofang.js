...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    UA = `jdapp;iPhone;10.1.4;14.6;${UUID};network/wifi;JDEbook/openapp.jdreader;model/iPhone9,2;addressid/0;appBuild/167814;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16E158;supportJDSHWK/1`;
    if (cookiesArr[i]) {
      cookie = cookiesArr[i];
