...
!(async () => {
  ...
  if (!res) {
    $.http.get({url: 'http://cdn.boledao.com/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('http://cdn.boledao.com/shareCodes/cfd.json')
  }
