...
[task_local]
#京喜财富岛
25 0,13,19 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "25 0,13,19 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="25 0,13,19 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_cfd.js, cronexpr="25 0,13,19 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("http://cdn.boledao.com/shareCodes/cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('http://cdn.boledao.com/shareCodes/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('http://cdn.boledao.com/shareCodes/cfd.json')
