...
cron 3 7,8 22-31,1-5 8,9 * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_king.js
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    UA = `jdapp;iPhone;10.1.1;14.3;${uuid};network/wifi;model/iPhone12,1;addressid/4199175193;appBuild/167774;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1`;
