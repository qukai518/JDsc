...
[task_local]
#小鸽有礼
3 0,7 * * * https://github.com/wulove/my_scripts/raw/master/jd_xgyl_wx.js, tag=小鸽有礼,  enabled=true

================Loon==============
[Script]
cron "3 0,7 * * *" script-path=https://github.com/wulove/my_scripts/raw/master/jd_xgyl_wx.js, tag=小鸽有礼

===============Surge=================
小鸽有礼 = type=cron,cronexp="3 0,7 * * *",wake-system=1,timeout=3600,script-path=https://github.com/wulove/my_scripts/raw/master/jd_xgyl_wx.js

============小火箭=========
小鸽有礼 = type=cron,script-path=https://github.com/wulove/my_scripts/raw/master/jd_xgyl_wx.js, cronexpr="3 0,7 * * *", timeout=3600, enable=true
 */
const $ = new Env('小鸽有礼');
