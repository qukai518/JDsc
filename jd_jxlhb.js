...
[task_local]
#京喜领88元红包
4 1,10 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxlhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "4 1,10 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="4 1,10 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxlhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxlhb.js, cronexpr="4 1,10 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('http://cdn.boledao.com/shareCodes/jxhb.json') || [];
...
function getAuthorShareCode(url = "http://cdn.boledao.com/shareCodes/jxhb.json") {
  return new Promise(resolve => {
    const options = {
