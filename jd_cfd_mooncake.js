...
[task_local]
#京喜财富岛合成月饼
0-59/10 0,2,11,15,16,17 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd_mooncake.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0-59/10 0,2,11,15,16,17 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd.js,tag=京喜财富岛合成月饼

===============Surge=================
京喜财富岛合成月饼= type=cron,cronexp="0-59/10 0,2,11,15,16,17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd.js

============小火箭=========
京喜财富岛合成月饼 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_cfd.js, cronexpr="0-59/10 0,2,11,15,16,17 * * *", timeout=3600, enable=true
 */
              ...
              if (data.iRet === 0) {
                ...
                if (data.strDT) {
                  ...
                  for (let j = 0; j < count; j++) {
                    let num = Math.ceil(Math.random() * 2 + 6)
