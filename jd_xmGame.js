...
第一个CK失效会退出脚本
————————————————
入口：[8.13-8.31 小米-星空大冒险 (https://lzdz1-isv.isvjcloud.com/dingzhi/xiaomi/gameupd/activity/1272964?activityId=dz2108100000412302&shareUuid=e7fc2f0d35bd4f8db654b8c580ed97c5)]
============Quantumultx===============
[task_local]
#8.13-8.31 小米-星空大冒险
45 5,18 13-31 8 * jd_xmGame.js, tag=8.13-8.31 小米-星空大冒险, enabled=true

================Loon==============
[Script]
cron "45 5,18 13-31 8 *" script-path=jd_xmGame.js,tag=8.13-8.31 小米-星空大冒险

===============Surge=================
8.13-8.31 小米-星空大冒险 = type=cron,cronexp="45 5,18 13-31 8 *",wake-system=1,timeout=3600,script-path=jd_xmGame.js

============小火箭=========
8.13-8.31 小米-星空大冒险 = type=cron,script-path=jd_xmGame.js, cronexpr="45 5,18 13-31 8 *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  $.shareUuid = 'e7fc2f0d35bd4f8db654b8c580ed97c5'
