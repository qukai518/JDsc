...
[task_local]
#跳跳乐瓜分京豆
1 0-23/6 * * * jd_jump.js, tag=跳跳乐瓜分京豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===================Loon==============
[Script]
cron "1 0-23/6 * * *" script-path=jd_jump.js, tag=跳跳乐瓜分京豆
===============Surge===============
[Script]
跳跳乐瓜分京豆 = type=cron,cronexp="1 0-23/6 * * *",wake-system=1,timeout=3600,script-path=jd_jump.js
====================================小火箭=============================
跳跳乐瓜分京豆 = type=cron,script-path=jd_jump.js, cronexpr="1 0-23/6 * * *", timeout=3600, enable=true
*/
