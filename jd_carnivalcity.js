...
[task_local]
#京东手机狂欢城
40 0-18/2 * 6 * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_carnivalcity.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "40 0-18/2 * 6 *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_carnivalcity.js, tag=京东手机狂欢城
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: "http://cdn.boledao.com/shareCodes/jd_cityShareCodes.json",headers:{
