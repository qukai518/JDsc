...
[task_local]
#领金贴
10 0 * * * jd_jintie_wx.js, tag=金贴小程序, enabled=true
===========Loon===============
[Script]
cron "10 0 * * *" script-path=jd_jintie_wx.js,tag=金贴小程序
=======Surge===========
金贴小程序 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=jd_jintie_wx.js
==============小火箭=============
金贴小程序 = type=cron,script-path=jd_jintie_wx.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('金贴小程序');
