...
==========================Quantumultx=========================
[task_local]
0 2,8,11,17 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxnc.js, tag=京喜农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxnc.png, enabled=true
=========================Loon=============================
[Script]
cron "0 2,8,11,17 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxnc.js,tag=京喜农场

=========================Surge============================
京喜农场 = type=cron,cronexp="0 2,8,11,17 * * *",timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxnc.js

=========================小火箭===========================
京喜农场 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_jxnc.js, cronexpr="0 2,8,11,17 * * *", timeout=3600, enable=true
*/
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    try {
      let options = {
        "url": `http://cdn.boledao.com/shareCodes/jxnc.txt`,
        "headers": {
